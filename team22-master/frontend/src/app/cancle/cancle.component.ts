...
export class CancleComponent implements OnInit {
  ...
  'bookingCancleReason', 'typeReasonName', 'bookingCancleStatus'];
  bookingCancleColumns: string[] = ['customerIDs', 'bookingId', 'staffName', 'styleName', 'bookingDate', 'statusBooking', 'category'];
