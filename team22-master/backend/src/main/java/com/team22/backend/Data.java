...
//    Date date = new Date();
    ...
    ApplicationRunner init(PositionRepository positionRepository,
                        ...
                        //    BookingCancleHistoryRepository  bookingCancleHistoryRepository,
        ...
        return args -> {
            ...
            //     RestoreType rtype = new RestoreType(restoreType);
            ...
            // bookingCancledb.setBookingCancleReason("ไม่ว่างไปงานแล้ว");
